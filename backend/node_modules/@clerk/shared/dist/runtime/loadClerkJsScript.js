...
const require_versionSelector = require('./versionSelector-pQO8ylIA.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.10.0");
